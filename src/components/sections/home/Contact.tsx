...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small business owners who trust Accolade for their accounting needs. Our team is here to help you get started and answer any questions.',
  ...
  method2Description: 'Get help from our experts',
  ...
  office2City: 'Austin',
  office2Address: 'Tech Quarter, 301 Congress Ave',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'San Francisco',
  office3Address: 'SOMA District, 555 Market Street',
  ...
  messagePlaceholder:
    'What type of business do you run? How many employees? What accounting challenges are you facing?',
} as const;
