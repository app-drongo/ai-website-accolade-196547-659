...
const DEFAULT_FEATURES = {
  ...
  feature4Description:
    'Handle multiple businesses, subsidiaries, and client accounts from a single, unified dashboard interface.',
  ...
  feature7Title: 'Banking & Payment APIs',
  feature7Description:
    'Connect seamlessly with 12,000+ banks and payment processors via secure Open Banking integrations.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert CPA Support',
  feature8Description:
    'Access certified accounting professionals for guidance, tax planning, and year-end financial preparation.',
  feature8Badge: 'Support',
  feature9Title: 'Bank-Level Security',
  feature9Description:
    'Your financial data is protected with 256-bit encryption, daily backups, and SOC 2 Type II compliance.',
