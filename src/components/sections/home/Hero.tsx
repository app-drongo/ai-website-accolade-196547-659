...
const DEFAULT_HERO = {
  ...
  description:
    'Streamline bookkeeping, automate invoicing, and get real-time financial insights. Built specifically for small businesses and entrepreneurs who want to focus on growth, not paperwork.',
  features: [
  ...
  imageAlt: 'Accolade dashboard showing financial analytics',
